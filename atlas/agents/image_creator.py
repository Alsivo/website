...
def create_image_prompt(
    ...
    return (
        ...
        "- depict one specific, believable everyday situation directly related to "
        "the reader's problem in the article\n"
        "- for meeting tools, show a real Japanese workplace meeting; for document "
        "tools, show a real desk and document-making scene; choose an equally concrete "
        "scene for other topics\n"
        ...
        "- real people may appear when the topic naturally involves meetings, work, "
        "learning, shopping, or daily life, but keep faces secondary and unidentifiable\n"
