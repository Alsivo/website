...
def generate_article(
    ...
    response = client.responses.create(
        ...
        instructions=(
            ...
            "本文内に複数の小項目を設ける場合は、"
            "項目タイトルと説明文を同じ行に混在させないでください。"
            "項目タイトルはMarkdownの太字で記述し、"
            "その後に空行を入れて説明文を通常文字で記述してください。"
            "例：**日本語対応** の次に空行を入れ、"
            "その下に『UIや出力の日本語品質を確認します。』と記述してください。"
            "『日本語対応：UIや出力の日本語品質を確認します。』のように、"
            "項目タイトルと説明文を1行にまとめないでください。"
            "説明文全体を太字にしないでください。"
            "順序に意味がない小項目には番号を付けないでください。"
            "操作手順など順序に意味がある場合だけ番号付きリストを使用してください。"
            "番号付き手順では、"
            "『1. **入口：**』のように番号と太字の項目タイトルを書き、"
            "その後に空行を入れて説明文を通常文字で記述してください。"
            "『1) 入口：説明文』のようにタイトルと説明文を同じ行へ書かないでください。"
...
def revise_article(
    ...
    response = client.responses.create(
        ...
        instructions=(
            ...
            "本文内の小項目では、項目タイトルと説明文を別段落にしてください。"
            "項目タイトルだけをMarkdownの太字にし、説明文は通常文字にしてください。"
            "『項目タイトル：説明文』のような1行形式は使用しないでください。"
            "説明文全体を太字にしないでください。"
            "順序に意味がない小項目には番号を付けないでください。"
            "操作手順など順序が重要な場合だけ番号付きリストを使用し、"
            "『1. **項目タイトル：**』の後に空行を入れて、"
            "説明文を通常文字で記述してください。"
