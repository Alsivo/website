...
def generate_title_layout(
    ...
    response = client.responses.create(
        ...
        instructions=(
            ...
            "『｜』『？』『！』『：』は"
            "意味上の強い区切りとして積極的に利用してください。"
            "『・』は語句を列挙するために使われることがあるため、"
            "意味を確認したうえで改行候補として利用してください。"

            "1〜2文字だけの極端に短い行を作らないでください。"
            "各行の文字数を完全に揃える必要はありません。"
            "多少長さに差があっても、"
            "意味として自然な改行を優先してください。"

            "【括弧に関する重要ルール】"
            "丸括弧『（ ）』内の内容は、"
            "原則として1つの意味のまとまりとして扱ってください。"
            "括弧内を途中で分割することは可能な限り避けてください。"

            "特に、"
            "『（PowerPoint/Googleスライド/Canva対応）』"
            "のような対応サービス、製品名、機能名などの列挙は、"
            "括弧内部で分割せず、"
            "括弧の直前で改行することを優先してください。"

            "悪い例："
            "『2026年最新・料金と機能で選ぶ（PowerPoint/』"
            "『Googleスライド/Canva対応）』"
            ...
            "スラッシュ『/』は、"
            "括弧内でサービス名や製品名を列挙している場合、"
            "原則として改行位置に使用しないでください。"

            "【blog_title_lines】"
            "ブログ用16:9画像のタイトルです。"
            "1〜3行で配置してください。"
            "画像ではタイトル文字サイズを固定するため、"
            "長いタイトルを1行へ詰め込みすぎないでください。"
            "1行はおおむね24文字前後までを目安としてください。"
            "ただし24文字は絶対的な上限ではありません。"
            "英数字は日本語より横幅が異なるため、"
            "文字数だけで判断しないでください。"
            "『｜』『？』『！』『：』などの強い区切りや、"
            "意味のまとまりの境界で自然に改行してください。"
            "長いタイトルでは2〜3行を積極的に使用してください。"
            "短いタイトルを不必要に細かく分割しないでください。"

            "【instagram_title_lines】"
            "1080×1350のInstagram画像用タイトルです。"
            "1〜5行で配置してください。"

            "最も重要なのは、"
            "日本語として意味の自然な位置で改行することです。"
            "文字数を揃えるためだけの改行は禁止です。"

            "1行はおおむね22〜24文字程度を目安としてください。"
            "ただし24文字は絶対的な上限ではありません。"
            "英数字は日本語と横幅が異なるため、"
            "文字数だけで判断しないでください。"
