...
def generate_image_copy(
    ...
    response = client.responses.create(
        ...
        instructions=(
            ...
            "画像はアルとシーボの会話として表示します。"
            "image_titleは、対象サービスをまだ使っていないアルが抱く"
            ...
            "短くする場合も目的語や対象を省略せず、画像だけを見た人が"
            "『何について困っているのか』『何を誰や何に任せたいのか』を"
            "一文だけで理解できるようにしてください。"
            "『毎日更新、どこまで任せて平気かな？』のように、何の更新か、"
            "何に任せるのかが分からない省略表現は禁止です。"
            "良い例は『ブログの毎日更新、AIにどこまで任せて平気かな？』です。"
            ...
            "シーボはアルの相談に直接答えてから、対象サービスを解決策として紹介し、"
            "記事で説明する内容へ自然につないでください。"
            "いきなり『記事を読めば分かる』『プランを決めやすくなる』などの"
            "記事説明から始めてはいけません。"
            "良い例は、アル『会議の議事録、自動で任せて平気かな？』、"
            "シーボ『Nottaっていう議事録AIツールを使ってみたら？"
            ...
            "社内向け略語は画像コピーに使用しないでください。"

            "『席・シート』『PoC』『KPI』『ワークフロー』などは、"
            "『利用人数・ライセンス数』『試験導入』"
            "『判断指標・確認項目』『作業手順』のように"
            "画像を一目見て分かる日本語へ言い換えてください。"

            "記事本文に専門用語が含まれていても、そのまま転載せず、"
            "製品の公式名称として不可欠な場合だけ使用してください。"
